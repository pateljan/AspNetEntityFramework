...
namespace EFCoreMoviesWebApi.Migrations
{
    ...
    [Migration("20220614121238_Products")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Actor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataOfBirth = new DateTime(1996, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Tom Holland"
                        },
                        new
                        {
                            ...
                            DataOfBirth = new DateTime(1948, 12, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            DataOfBirth = new DateTime(1965, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Robert Downey Jr."
                        },
                        new
                        {
                            Id = 4,
                            DataOfBirth = new DateTime(1981, 6, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Chris Evans"
                        },
                        new
                        {
                            Id = 5,
                            DataOfBirth = new DateTime(1972, 5, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Dwayne Johnson"
                        },
                        new
                        {
                            Id = 6,
                            DataOfBirth = new DateTime(2000, 11, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Auli'i Cravalho"
                        },
                        new
                        {
                            Id = 7,
                            DataOfBirth = new DateTime(1984, 11, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Scarlett Johansson"
                        },
                        new
                        {
                            Id = 8,
                            DataOfBirth = new DateTime(1964, 9, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Keanu Reeves"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.CinemaDetail", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Keyless.CinemaWithoutLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Keyless.MovieWithCounts", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Log", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.MovieActor", b =>
                {
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.RentMovie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.CardPayment", b =>
                {
                    b.HasBaseType("EFCoreMoviesWebApi.Entities.Payment");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 16.25m,
                            PaymentDate = new DateTime(2022, 4, 9, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentType = 2,
                            Last4Digits = "1234"
                        },
                        new
                        {
                            Id = 4,
                            Amount = 22m,
                            PaymentDate = new DateTime(2022, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentType = 2,
                            Last4Digits = "8555"
                        });
                });

            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Merchandising", b =>
                {
                    b.HasBaseType("EFCoreMoviesWebApi.Entities.Product");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.PaypalPayment", b =>
                {
                    b.HasBaseType("EFCoreMoviesWebApi.Entities.Payment");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 125m,
                            PaymentDate = new DateTime(2022, 2, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentType = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Amount = 256m,
                            PaymentDate = new DateTime(2022, 4, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentType = 1,
                            EmailAddress = "claudia@gmail.com"
                        });
                });

            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.RentableMovie", b =>
                {
                    b.HasBaseType("EFCoreMoviesWebApi.Entities.Product");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Actor", b =>
                {
                    b.OwnsOne("EFCoreMoviesWebApi.Entities.Address", "BillingAddress", b1 =>
                        {
                    ...
                    b.OwnsOne("EFCoreMoviesWebApi.Entities.Address", "HomeAddress", b1 =>
                        {
                            b1.Property<int>("ActorId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Cinema", b =>
                {
                    b.OwnsOne("EFCoreMoviesWebApi.Entities.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.CinemaDetail", b =>
                {
                    b.HasOne("EFCoreMoviesWebApi.Entities.Cinema", "Cinema")
                        ...
                        .HasForeignKey("EFCoreMoviesWebApi.Entities.CinemaDetail", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Message", b =>
                {
                    b.HasOne("EFCoreMoviesWebApi.Entities.Person", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreMoviesWebApi.Entities.Person", "Sender")
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.MovieActor", b =>
                {
                    b.HasOne("EFCoreMoviesWebApi.Entities.Actor", "Actor")
                        .WithMany("MovieActors")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreMoviesWebApi.Entities.Movie", "Movie")
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.RentMovie", b =>
                {
                    ...
                    b.HasOne("EFCoreMoviesWebApi.Entities.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.Merchandising", b =>
                {
                    b.HasOne("EFCoreMoviesWebApi.Entities.Product", null)
                        .WithOne()
                        .HasForeignKey("EFCoreMoviesWebApi.Entities.Merchandising", "Id")
            ...
            modelBuilder.Entity("EFCoreMoviesWebApi.Entities.RentableMovie", b =>
                {
                    b.HasOne("EFCoreMoviesWebApi.Entities.Product", null)
                        .WithOne()
                        .HasForeignKey("EFCoreMoviesWebApi.Entities.RentableMovie", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
